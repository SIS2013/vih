...
public class FacebookActivity extends FragmentActivity {
    ...
    private final String PENDING_ACTION_BUNDLE_KEY = "com.example.vihapp2:PendingAction";
    ...
    private void updateUI() {
        ...
        prueba.setEnabled(enableButtons);
	...
	private void onClickPrueba() {
    	...
    	/*
    	Facebook facebook = new Facebook("356517991160739");
		try {
			
			String response = facebook.request("me");
			JSONObject json = Util.parseJson(response);
			//JSONArray data = json.getJSONArray("data");
			Log.d("data:", json.optString("id"));
